...
const CreativeControl = () => {
  useGSAP(() => {
    gsap.set('.video', { width: 1000, position: 'absolute', zIndex: 2, borderRadius: 20 });
  ...
  return (
    <div className="relative padding_ creative-control space-y-12 py-12 flex flex-col sm:flex-row gap-6 overflow-hidden">
      <div className="left-text min-h-full sm:basis-1/3 flex justify-center place-items-center text-center transition-all">
      ...
      <div className="right-text flex flex-col sm:basis-1/3 justify-center items-center h-fit ">
